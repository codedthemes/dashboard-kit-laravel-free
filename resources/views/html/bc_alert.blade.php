	...
	<div class="pcoded-content">
		...
		<div class="row mb-3">
				<div class="col-md-8">
					...
					<p class="f-w-500">Check out <a href="https://dashboardkit.io/bootstrap/docs/index-bc-package.html#page-alert" target="_blank" class="badge bg-light-primary">Documentation</a></p>
				</div>
		</div>
		<div class="row">
			<!-- [ basic-alert ] start -->
