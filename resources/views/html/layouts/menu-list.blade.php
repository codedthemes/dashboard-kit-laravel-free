...
<li class="pc-item pc-hasmenu">
	<a href="#!" class="pc-link"><span class="pc-micon"><i class="material_icons_two_tone">layers</i></span><span class="pc-mtext">Layouts</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
	<ul class="pc-submenu">
		...
		<li class="pc-item"><a target="_blank" class="pc-link" href="{{ route('layout_navtoggler') }}">Navbar Toggle</a></li>
	</ul>
</li>
<li class="pc-item pc-hasmenu">
...
<li class="pc-item pc-hasmenu">
	...
	<ul class="pc-submenu">
		...
		<li class="pc-item"><a class="pc-link" href="{{ route('icon_material') }}">Material</a></li>
	</ul>
</li>
<li class="pc-item pc-caption">
	<label>Forms</label>
	...
	<ul class="pc-submenu">
		...
		<li class="pc-item pc-hasmenu">
			...
			<ul class="pc-submenu">
				...
				<li class="pc-item"><a class="pc-link" href="{{ route('form2_choices') }}">Choices js</a></li>
...
<li class="pc-item pc-hasmenu">
	...
	<ul class="pc-submenu">
		<li class="pc-item"><a class="pc-link" href="{{ route('form_wizard') }}">Wizard 1</a></li>
		...
		<li class="pc-item"><a class="pc-link" href="{{ route('page_wizard3') }}">Wizard 3</a></li>
	</ul>
</li>
<li class="pc-item pc-caption">
	<label>table</label>
...
<li class="pc-item pc-hasmenu">
	...
	<ul class="pc-submenu">
		...
		<li class="pc-item"><a class="pc-link" href="{{ route('ecom_product_list') }}">Product list</a></li>
