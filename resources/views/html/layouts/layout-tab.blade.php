				...
				<div class="navbar-content">
						...
						<ul class="pc-navbar">
							...
							<li class="pc-item pc-hasmenu">
								...
								<ul class="pc-submenu">
									...
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_clipboard' }}">Clipboard</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_nouislider' }}">Nouislider</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_repeater' }}">Repeater</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_switchjs' }}">Switchjs</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_typeahead' }}">Typeahead</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_touchspin' }}">Touchspin</a></li>
								</ul>
							</li>
							<li class="pc-item pc-hasmenu">
								<a href="#!" class="pc-link "><span class="pc-mtext">Text Editors</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
								<ul class="pc-submenu">
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_tinymce' }}">Tinymce</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_quill' }}">Quill</a></li>
									<!-- <li class="pc-item"><a class="pc-link" href="{{ route('form2_summernote' }}">Summernote</a></li> -->
									<li class="pc-item pc-hasmenu">
										<a class="pc-link" href="#">CK editor<span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
										<ul class="pc-submenu">
											<li class="pc-item"><a class="pc-link" href="{{ route('editor_classic' }}">classic</a></li>
											<li class="pc-item"><a class="pc-link" href="{{ route('editor_document' }}">Document</a></li>
											<li class="pc-item"><a class="pc-link" href="{{ route('editor_inline' }}">Inline</a></li>
											<li class="pc-item"><a class="pc-link" href="{{ route('editor_balloon' }}">Balloon</a></li>
										</ul>
									</li>
									<li class="pc-item"><a class="pc-link" href="{{ route('editor_trumbowyg' }}">Trumbowyg editor</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_markdown' }}">Markdown</a></li>
								</ul>
							</li>
							<li class="pc-item pc-hasmenu">
								<a href="#!" class="pc-link "><span class="pc-mtext">Form Layouts</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
								<ul class="pc-submenu">
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_lay_default' }}">Layouts</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_lay_multicolumn' }}">Multicolumn</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_lay_actionbars' }}">Actionbars</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_lay_stickyactionbars' }}">Sticky Actionbars</a></li>
								</ul>
							</li>
							<li class="pc-item pc-hasmenu">
								<a href="#!" class="pc-link "><span class="pc-mtext">File upload</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
								<ul class="pc-submenu">
									<li class="pc-item"><a class="pc-link" href="{{ route('file_upload' }}">Dropzone</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('form2_flu_uppy' }}">Uppy</a></li>
								</ul>
							</li>
							<li class="pc-item">
					...
					<div class="pc-tabcontent" data-value="Other">
						<ul class="pc-navbar">
							...
							<li class="pc-item"><a href="{{ route('landing' }}" class="pc-link "><span class="pc-micon"><i class="material-icons-two-tone">collections_bookmark</i></span><span class="pc-mtext">Landing</span></a></li>
							<li class="pc-item pc-hasmenu">
							...
							<li class="pc-item pc-hasmenu">
								...
								<ul class="pc-submenu">
									<li class="pc-item"><a class="pc-link" href="{{ route('page' }}.html">Faq 1</a></li>
									<li class="pc-item"><a class="pc-link" href="{{ route('page' }}.html">Faq 2</a></li>
									<li class="pc-item pc-hasmenu">
							...
							<li class="pc-item"><a href="{{ route('sample_page' }}" class="pc-link "><span class="pc-micon"><i class="material-icons-two-tone">storefront</i></span><span class="pc-mtext">Sample page</span></a></li>
						</ul>
					</div>
				</div>
			</div>
