...
</span><span class="c1"></span>  <span class="k">&commat;include</span><span class="nd"> row-cols</span><span class="p">(</span><span class="mi">3</span><span class="p">);</span>

  <span class="c1">// Five columns from medium breakpoint up
</span><span class="c1"></span>  <span class="k">&commat;include</span><span class="nd"> media-breakpoint-up</span><span class="p">(</span><span class="n">md</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">&commat;include</span><span class="nd"> row-cols</span><span class="p">(</span><span class="mi">5</span><span class="p">);</span>
  <span class="p">}</span>
...
</span><span class="c1"></span><span class="k">&commat;include</span><span class="nd"> make-row</span><span class="p">();</span>

<span class="c1">// Make the element grid-ready (applying everything but the width)
</span><span class="c1"></span><span class="k">&commat;include</span><span class="nd"> make-col-ready</span><span class="p">();</span>
<span class="k">&commat;include</span><span class="nd"> make-col</span><span class="p">(</span><span class="nv">$size</span><span class="o">,</span> <span class="nv">$columns</span><span class="o">:</span> <span class="nv">$grid-columns</span><span class="p">);</span>

<span class="c1">// Get fancy by offsetting, or changing the sort order
</span><span class="c1"></span><span class="k">&commat;include</span><span class="nd"> make-col-offset</span><span class="p">(</span><span class="nv">$size</span><span class="o">,</span> <span class="nv">$columns</span><span class="o">:</span> <span class="nv">$grid-columns</span><span class="p">);</span></code></pre>
						</div>
  ...
  <span class="k">&commat;include</span><span class="nd"> make-container</span><span class="p">();</span>
...
<span class="nc">.example-row</span> <span class="p">{</span>
  <span class="k">&commat;include</span><span class="nd"> make-row</span><span class="p">();</span>
<span class="p">}</span>

<span class="nc">.example-content-main</span> <span class="p">{</span>
  <span class="k">&commat;include</span><span class="nd"> make-col-ready</span><span class="p">();</span>

  <span class="k">&commat;include</span><span class="nd"> media-breakpoint-up</span><span class="p">(</span><span class="n">sm</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">&commat;include</span><span class="nd"> make-col</span><span class="p">(</span><span class="mi">6</span><span class="p">);</span>
  <span class="p">}</span>
  <span class="k">&commat;include</span><span class="nd"> media-breakpoint-up</span><span class="p">(</span><span class="n">lg</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">&commat;include</span><span class="nd"> make-col</span><span class="p">(</span><span class="mi">8</span><span class="p">);</span>
  <span class="p">}</span>
<span class="p">}</span>
...
<span class="nc">.example-content-secondary</span> <span class="p">{</span>
  ...
  <span class="p">}</span>
  <span class="k">&commat;include</span><span class="nd"> media-breakpoint-up</span><span class="p">(</span><span class="n">lg</span><span class="p">)</span> <span class="p">{</span>
    <span class="k">&commat;include</span><span class="nd"> make-col</span><span class="p">(</span><span class="mi">4</span><span class="p">);</span>
  <span class="p">}</span>
<span class="p">}</span></code></pre>
						</div>
