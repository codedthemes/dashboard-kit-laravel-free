                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Font Awesome 5</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="#!">Icons</a></li>
                            <li class="breadcrumb-item">Font Awesome 5</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p>Use icon with <code>&lt;i class="&lt;&lt; Copyed code &gt;&gt;"&gt;</code> in you html code</p>
                    </div>
...
<script type="text/javascript">
    var iconlistbrand = ['fa-500px', 'fa-accessible-icon', 'fa-accusoft', 'fa-acquisitions-incorporated', 'fa-adn', 'fa-adobe', 'fa-adversal', 'fa-affiliatetheme', 'fa-algolia', 'fa-alipay', 'fa-amazon', 'fa-amazon-pay',
        ...
        'fa-neos', 'fa-nimblr', 'fa-node', 'fa-node-js', 'fa-npm', 'fa-ns8', 'fa-nutritionix', 'fa-odnoklassniki', 'fa-odnoklassniki-square', 'fa-old-republic', 'fa-opencart', 'fa-openid', 'fa-opera', 'fa-optin-monster',
    ...
    for (var i = 0, l = iconlist.length; i < l; i++) {
        $('#icon-wrapper').append(
            '<div class="i-block" data-clipboard-text="fas ' + iconlist[i] + '" data-filter="' + iconlist[i] + '"  data-bs-toggle="tooltip" title="' + iconlist[i] + '">' +
            '<i class="fas ' + iconlist[i] + '"></i>' +
            '</div>');
    }
    $('#icon-wrapper').append('<br><h3 class="m-t-20 ">Brand</h3>');
    for (var i = 0, l = iconlistbrand.length; i < l; i++) {
        $('#icon-wrapper').append(
            '<div class="i-block" data-clipboard-text="fab ' + iconlistbrand[i] + '" data-filter="' + iconlistbrand[i] + '"  data-bs-toggle="tooltip" title="' + iconlistbrand[i] + '">' +
