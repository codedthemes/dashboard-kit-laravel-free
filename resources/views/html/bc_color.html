...
<div class="pc-container">
    <div class="pcoded-content">
        ...
        <div class="row mb-3">
            <div class="col-md-8">
                <h3>Color</h3>
                <p class="lead">Documentation and examples for Color, our small count and labeling component.</p>
...
<script>
    $(window).on('load', function() {
        var iclp = new ClipboardJS('.color-block');
        iclp.on('success', function(e) {
            console.log("copy");
            $(e.trigger).append("<span class='ic-badge badge bg-success float-end'>copied</span>");
            setTimeout(function() {
                $('.color-block').children('.ic-badge').remove();
            }, 3000);
        });

        iclp.on('error', function(e) {
            $(e.trigger).append("<span class='ic-badge badge bg-danger float-end'>Error</span>");
            setTimeout(function() {
                $('.color-block').children('.ic-badge').remove();
            }, 3000);
        });
