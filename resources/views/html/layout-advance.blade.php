            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-md-end">
                    ...
                    <div class="btn-group ms-2">
                        <button class="btn btn-sm btn-danger dropdown-toggle arrow-none rounded-pill" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i data-feather="plus"></i></button>
