...
$(document).ready(function() {
    ...
    $("#add-btn").on("click", function() {
        ...
        if (task == "") {
            ...
            var add_todo = $('<div class="to-do-list mb-3" id="' + i + '">'+
                '<div class="d-inline-block">'+
                    '<div class="check-task form-check">'+
                        '<input type="checkbox" class="form-check-input" onclick="check_task(' + i + ')" id="checkbox' + i + '">'+
                        '<label class="form-check-label" for="checkbox' + i + '">' + task + '</label>'+
                    '</div>'+
                '</div>'+
                '<div class="float-right"><a onclick="delete_todo(' + i + ');" href="#!" class="delete_todolist"><i class="far fa-trash-alt"></i></a></div>'+
            '</div>');
            i++;
    ...
    $(".btn_save").on("click", function() {
        ...
        if (saveTask == "") {
            ...
            var add_todo = $('<div class="to-do-list mb-3" id="' + i + '"><div class="d-inline-block"><div class="check-task form-check"><input type="checkbox" class="form-check-input" onclick="check_task(' + i + ')" id="checkbox' + i + '"><label class="form-check-label" for="checkbox' + i + '">' + saveTask + '</label></div></div><div class="float-right"><a onclick="delete_todo(' + i + ');" href="#!" class="delete_todolist"><i class="far fa-trash-alt"></i></a></div></div>');
            i++;
